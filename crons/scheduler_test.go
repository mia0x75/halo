...
const TestTaskName = "github.com/mia0x75/halo/crons.(*CallbackMock).CallNoArgs-fm"
...
func TestCancelTask(t *testing.T) {
	...
	err := scheduler.Cancel(ID("123456"))
	if err == nil {
...
func TestPopulateTasks(t *testing.T) {
	...
	// 	Duration:    "5s",
	// 	IsRecurring: "0",
	// 	Name:        "github.com/mia0x75/halo/crons/task.(*CallbackMock).CallNoArgs-fm",
	// 	Params:      "",
	// }
